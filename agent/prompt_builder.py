...
_HERMES_MD_NAMES = (".sinria.md", "SINRIA.md", ".hermes.md", "HERMES.md")


def _find_hermes_md(cwd: Path) -> Optional[Path]:
    """Discover the nearest Sinria/Hermes project context file.
...
def _load_hermes_md(cwd_path: Path) -> str:
    """.sinria.md / SINRIA.md / .hermes.md / HERMES.md — walk to git root."""
...
def build_context_files_prompt(cwd: Optional[str] = None, skip_soul: bool = False) -> str:
    ...
    Priority (first found wins — only ONE project context type is loaded):
      1. .sinria.md / SINRIA.md / .hermes.md / HERMES.md  (walk to git root)
