...
This module exposes a curated subset of those Sinria tools to the
...
def _build_server() -> Any:
    """Create the FastMCP server with Sinria tools attached. Lazy imports
    ...
    # Discover Sinria tools so dispatch works.
    ...
    mcp = FastMCP(
        "hermes-tools",
        instructions=(
            "Sinria's tool surface, exposed for use inside a Codex "
