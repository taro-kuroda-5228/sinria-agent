...
Owns one Codex thread per Sinria session. Drives `turn/start`, consumes
...
class CodexAppServerSession:
    """One Codex thread per Sinria session, lifetime owned by AIAgent.
    ...
    def ensure_started(self) -> str:
        ...
        self._client.initialize(
            client_name=_cli_command_name(),
            client_title=_client_product_title(),
