...
try:
    ...
    def get_hermes_home() -> Path:  # type: ignore[misc]
        ...
        if val:
            return Path(val)
        home_name = ".sinria" if (_os.environ.get("HERMES_CLI_NAME") or "").lower() == "sinria" else ".hermes"
...
ACHIEVEMENTS: List[Dict[str, Any]] = [
    ...
    {"id": "toolchain_maxxer", "name": "Toolchain Maxxer", "description": "Use a wide spread of distinct Sinria tools in one session.", "category": "Agent Autonomy", "kind": "best_session", "icon": "nodes", "threshold_metric": "max_distinct_tools_in_session", "tiers": tiers([18, 28, 45, 70, 100])},
    ...
    {"id": "open_weights_pilgrim", "name": "Open Weights Pilgrim", "description": "Actually chat with local/open-weight models through Sinria session metadata.", "category": "Model Lore", "kind": "lifetime", "icon": "terminal", "threshold_metric": "local_model_chat_sessions", "tiers": tiers([1, 3, 10, 30, 100])},

    # Workflow Intelligence
    {"id": "toolset_cartographer", "name": "Toolset Cartographer", "description": "Navigate Sinria toolsets deliberately instead of treating tools as a blur.", "category": "Hermes Native", "kind": "lifetime", "icon": "compass", "threshold_metric": "toolset_events", "tiers": tiers([20, 60, 200, 600, 1500])},
    ...
    # Lifestyle
    {"id": "marathon_operator", "name": "Marathon Operator", "description": "Accumulate a serious number of Sinria sessions.", "category": "Lifestyle", "kind": "lifetime", "icon": "marathon", "threshold_metric": "session_count", "tiers": tiers([75, 200, 500, 1500, 5000])},
...
METRIC_LABELS = {
    ...
    "max_distinct_tools_in_session": "distinct Sinria tools used in one session",
    ...
    "local_model_chat_sessions": "Sinria sessions whose model metadata is local/open-weight",
...
def scan_sessions(
    ...
    """Scan Sinria sessions and build per-session achievement stats.
