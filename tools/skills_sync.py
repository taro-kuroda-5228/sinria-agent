...
Copies bundled skills from the repo's skills/ directory into $SINRIA_HOME/skills/
...
The manifest lives at $SINRIA_HOME/skills/.bundled_manifest.
"""
...
def _compute_relative_dest(skill_dir: Path, bundled_dir: Path) -> Path:
    ...
    e.g., bundled/skills/mlops/axolotl -> $SINRIA_HOME/skills/mlops/axolotl
    """
...
def sync_skills(quiet: bool = False) -> dict:
    """
    Sync bundled skills into $SINRIA_HOME/skills/ using the manifest.
