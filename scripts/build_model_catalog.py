#!/usr/bin/env python3
"""Build the Sinria Model Catalog — a centralized JSON manifest of curated models.
...
Sinria CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Sinria release.
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "sinria-agent repo",
            "docs": "https://taro-kuroda-5228.github.io/sinria-agent/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
