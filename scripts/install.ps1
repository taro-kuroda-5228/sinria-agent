...
param(
    ...
    [switch]$SkipSetup,
    [string]$Branch = "main",
    [string]$HermesHome = "$env:LOCALAPPDATA\sinria",
...
function Set-PathVariable {
    ...
    if (-not $currentSinriaHome -or $currentSinriaHome -ne $HermesHome) {
        [Environment]::SetEnvironmentVariable("SINRIA_HOME", $HermesHome, "User")
        Write-Success "Set SINRIA_HOME=$HermesHome"
    }
    $currentHermesHome = [Environment]::GetEnvironmentVariable("HERMES_HOME", "User")
    if (-not $currentHermesHome -or $currentHermesHome -ne $HermesHome) {
        [Environment]::SetEnvironmentVariable("HERMES_HOME", $HermesHome, "User")
        Write-Info "Set legacy HERMES_HOME=$HermesHome for compatibility"
    }
    $env:SINRIA_HOME = $HermesHome
...
function Write-Completion {
    ...
    Write-Host "$HermesHome\sinria-agent\"
    Write-Host ""
