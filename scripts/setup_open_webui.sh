...
# Bootstrap Open WebUI against Sinria's OpenAI-compatible API server.
#
...
HERMES_API_MODEL_NAME="${HERMES_API_MODEL_NAME:-Sinria}"
...
install_systemd_user_service() {
  ...
  cat > "$unit" <<EOF
[Unit]
Description=Open WebUI connected to Sinria
...
main() {
  ...
  log 'Restarting Sinria gateway so API server settings take effect...'
