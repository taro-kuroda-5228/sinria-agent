#!/usr/bin/env python3
"""
Sinria CLI - Interactive Terminal Interface

A command-line interface for Sinria, inspired by Claude Code.
...
class HermesCLI:
    ...
    def run(self):
        ...
        try:
            ...
            _welcome_text = _welcome_skin.get_branding("welcome", "Welcome to Sinria! Type your message or /help for commands.")
            _welcome_color = _welcome_skin.get_color("banner_text", "#FFF8DC")
        except Exception:
            _welcome_text = "Welcome to Sinria! Type your message or /help for commands."
        ...
        def handle_ctrl_z(event):
            ...
            from prompt_toolkit.application import run_in_terminal
            from hermes_cli.skin_engine import get_active_skin
            agent_name = get_active_skin().get_branding("agent_name", "Sinria")
        ...
        def _get_clarify_display():
            ...
            box_width = _panel_box_width("Sinria needs your input", preview_lines)
            inner_text_width = max(8, box_width - 2)
            ...
            lines.append(('class:clarify-title', 'Sinria needs your input'))
            lines.append(('class:clarify-border', ' ' + ('─' * max(0, box_width - len("Sinria needs your input") - 3)) + '╮\n'))
            if not use_compact_chrome:
...
def main(
    ...
    """
    Sinria CLI - Interactive AI Assistant
    ...
    if gateway:
        ...
        print("Starting Sinria Gateway (messaging platforms)...")
