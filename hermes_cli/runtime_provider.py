...
def _get_named_custom_provider(requested_provider: str) -> Optional[Dict[str, Any]]:
            ...
            if requested_norm in {ep_name, name_norm, f"custom:{name_norm}"}:
                ...
                if base_url:
                    result = {
                        ...
                        "allow_global_key_fallback": entry.get("allow_global_key_fallback", True),
                    }
    ...
    if isinstance(custom_providers, dict):
        logger.warning(
            ...
            f"Run '{_cli_command_name()} doctor' for details."
        )
        return None
...
def _resolve_named_custom_runtime(
    *,
    ...
    if custom_provider.get("allow_global_key_fallback", True):
