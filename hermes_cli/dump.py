"""
Dump command for the local CLI.

Outputs a compact, plain-text summary of the active runtime setup
...
def _redact(value: str) -> str:
    ...
    ``dump`` formats empty values as blank, not as ``"(not set)"``).
    """
...
def run_dump(args):
    ...
    lines = []
    lines.append(f"--- {_cli_command_name()} dump ---")
