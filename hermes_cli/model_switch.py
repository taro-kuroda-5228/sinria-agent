...
_HERMES_MODEL_WARNING = (
    ...
    "for use with Sinria. They lack the tool-calling capabilities "
    ...
    if explicit_provider:
        ...
        if pdef is None:
            _switch_err = (
                ...
                f"Check '{_cli_command_name()} model' for available providers, or define it "
            ...
            try:
                ...
                if _cfg_issues:
                    _switch_err += f"\n\nRun '{_cli_command_name()} doctor' — config issues detected:"
...
def list_authenticated_providers(
    ...
    # https://raw.githubusercontent.com/taro-kuroda-5228/sinria-agent/main/website/static/api/model-catalog.json so
