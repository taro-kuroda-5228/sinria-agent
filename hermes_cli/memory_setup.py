...
from hermes_constants import display_sinria_home, get_sinria_home
...
def _plugins_display_path() -> str:
    return f"{display_sinria_home()}/plugins/"
...
def _install_dependencies(provider_name: str) -> None:
    ...
    if not uv_path:
        ...
        print(f"  Then re-run: {_cli_command_name()} memory setup")
        return
...
def cmd_setup_provider(provider_name: str) -> None:
    ...
    if not match:
        ...
        print(f"  Run '{_cli_command_name()} memory setup' to see available providers.\n")
        return
    ...
    if hasattr(provider, "post_setup"):
        hermes_home = str(get_sinria_home())
...
def cmd_setup(args) -> None:
    ...
    if not providers:
        ...
        print(f"  Install a plugin to {_plugins_display_path()} and try again.\n")
        return
...
def cmd_status(args) -> None:
    ...
    if provider_name:
        ...
        if found:
            ...
            print(f"  Install the '{provider_name}' memory plugin to {_plugins_display_path()}")
