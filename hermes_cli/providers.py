"""
Single source of truth for provider identity in Sinria.
...
2. **Provider overlays** — transport type, auth patterns, aggregator flags,
...
# -- Provider overlay --------------------------------------------------------
# CLI-specific metadata that models.dev doesn't provide.

@dataclass(frozen=True)
class HermesOverlay:
    """CLI-specific provider metadata layered on top of models.dev."""
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    Resolution order:
      1. Provider overlays (for providers not in models.dev: nous, openai-codex, etc.)
      2. models.dev catalog + overlay metadata
