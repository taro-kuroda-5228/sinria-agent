...
MIGRATION_MARKER = (
    "# managed by sinria-agent — `hermes codex-runtime migrate` regenerates this section"
)
MIGRATION_END_MARKER = (
    "# end sinria-agent managed section"
)
...
def _translate_one_server(
    ...
    """Translate one Sinria MCP server config to the codex inline-table dict
