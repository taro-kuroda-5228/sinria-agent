"""
Session-scoped context variables for the Sinria gateway.
...
_SESSION_WORKSPACE_CWD: ContextVar = ContextVar("TERMINAL_CWD", default=_UNSET)
...
_VAR_MAP = {
    ...
    "TERMINAL_CWD": _SESSION_WORKSPACE_CWD,
