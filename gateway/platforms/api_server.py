...
- GET  /v1/models                  — lists sinria-agent as an available model
...
AnythingLLM, NextChat, ChatBox, etc.) can connect to sinria-agent
...
def _derive_chat_session_id(
    ...
    the same Sinria session (and therefore the same Docker container sandbox
...
class APIServerAdapter(BasePlatformAdapter):
    ...
    and routes them through sinria-agent's AIAgent.
    """
    ...
    async def _handle_health(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({"status": "ok", "platform": "sinria-agent"})
    ...
    async def _handle_models(self, request: "web.Request") -> "web.Response":
        """GET /v1/models — return sinria-agent as an available model."""
    ...
    async def _handle_capabilities(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({
            ...
            "runtime": {
                ...
                "split_runtime": False,
                "description": (
                    "The API server creates a server-side Sinria AIAgent; "
    ...
    async def _handle_chat_completions(self, request: "web.Request") -> "web.Response":
        ...
        if provided_session_id:
            ...
            # conversation map to the same Sinria session.  The first user
