...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/taro-kuroda-5228/sinria-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/sinria-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/taro-kuroda-5228/sinria-agent',
          label: 'Home',
          position: 'right',
        },
        {
        ...
        {
          href: 'https://github.com/taro-kuroda-5228/sinria-agent/discussions',
          label: 'Community',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Community', href: 'https://github.com/taro-kuroda-5228/sinria-agent/discussions' },
            { label: 'GitHub Discussions', href: 'https://github.com/taro-kuroda-5228/sinria-agent/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/taro-kuroda-5228/sinria-agent' },
            { label: 'Medical Horizon', href: 'https://github.com/Medical-Horizon' },
          ],
        },
      ],
      copyright: `Built by <a href="https://github.com/Medical-Horizon">Medical Horizon</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
