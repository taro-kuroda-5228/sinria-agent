#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Sinria docs site.
...
Both publish at:
  https://taro-kuroda-5228.github.io/sinria-agent/docs/llms.txt
  https://taro-kuroda-5228.github.io/sinria-agent/docs/llms-full.txt
...
SITE_BASE = "https://taro-kuroda-5228.github.io/sinria-agent/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Sinria as a Python Library", None),
        ("guides/use-mcp-with-hermes", "Use MCP with Sinria", None),
        ("guides/use-voice-mode-with-hermes", "Use Voice Mode with Sinria", None),
        ("guides/use-soul-with-hermes", "Use SOUL.md with Sinria", None),
        ("guides/build-a-hermes-plugin", "Build a Sinria Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Sinria"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Sinria Agent")
    lines.append("")
    lines.append(
        "> Medical Horizon's independent AI agent platform for healthcare institutions. "
        "Sinria is a terminal-native autonomous coding and task agent with persistent memory, agent-created skills, "
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/Medical-Horizon/"
        "sinria-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/taro-kuroda-5228/sinria-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Sinria Agent — Full Documentation\n",
        (
            "This file is the entire Sinria Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Sinria, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://taro-kuroda-5228.github.io/sinria-agent/docs\n",
        "Short index: https://taro-kuroda-5228.github.io/sinria-agent/docs/llms.txt\n",
        "\n---\n\n",
    ]
