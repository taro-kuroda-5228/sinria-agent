...
slug: /
sidebar_position: 0
title: "Sinria Agent Documentation"
description: "Medical Horizon's confidential-ready AI agent platform. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
Medical Horizon's confidential-ready AI agent platform. Sinria keeps the self-improving learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/taro-kuroda-5228/sinria-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
- **Provider-flexible** — Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any compatible endpoint
...
- **Research-ready** — Batch processing, trajectory export, and RL training with Atropos
