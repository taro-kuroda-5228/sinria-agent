...
_HERMES_CORE_TOOLS = [
    ...
    "ml_training",
    # Sinria-safe SaaS, clinical, and MedEvidence integration planning
    "sinria_integrations",
    # Cronjob management
    "cronjob",
...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `sinria tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    "ml_training": {
        "description": (
            "Machine-learning training and LLM fine-tuning helpers: environment "
            "inspection, dataset/export planning, smoke validation, and command "
            "scaffolding. Does not run long training jobs directly; use "
            "terminal/process so progress and failures remain visible."
        ),
        "tools": ["ml_training"],
        "includes": []
    },
    ...
    "sinria_integrations": {
        "description": (
            "Sinria-safe SaaS, EMR/EHR, FHIR/HL7, and MedEvidence connector "
            "planning. Metadata-only and local: lists connectors/skills and "
            "returns sanitized, approval-gated operation plans without external "
            "API calls."
        ),
        "tools": ["sinria_integrations"],
        "includes": []
    },
