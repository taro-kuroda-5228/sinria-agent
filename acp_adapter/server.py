"""ACP agent server — exposes Sinria via the Agent Client Protocol."""
...
def _content_blocks_to_openai_user_content(
    ...
    """Convert ACP prompt blocks into a Sinria/OpenAI-compatible user content payload."""
...
class HermesACPAgent(acp.Agent):
    """ACP Agent implementation wrapping Sinria AIAgent."""
    ...
    async def initialize(
        ...
        **kwargs: Any,
        ...
        return InitializeResponse(
            ...
            agent_info=Implementation(name="sinria-agent", version=HERMES_VERSION),
    ...
    def _cmd_version(self, args: str, state: SessionState) -> str:
        return f"Sinria v{HERMES_VERSION}"
