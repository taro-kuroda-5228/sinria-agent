...
class TestWebSearchSchema:
    ...
    def test_web_search_blocks_confidential_query_before_backend_call(self):
        import tools.web_tools
        ...
        with patch("tools.web_tools._get_search_backend", return_value="parallel"), \
            ...
            result = json.loads(tools.web_tools.web_search_tool("社外秘 token=secret-value を検索", limit=3))
