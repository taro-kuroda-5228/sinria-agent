...
class TestHermesTokenStorage:
    def test_sinria_fallback_token_dir_uses_sinria_home_when_constants_unavailable(self, tmp_path, monkeypatch):
        import builtins
        ...
        assert _get_token_dir() == tmp_path / ".sinria" / "mcp-tokens"
