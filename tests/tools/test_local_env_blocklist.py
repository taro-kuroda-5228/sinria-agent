...
Verifies that Sinria-managed provider, tool, and gateway env vars are
stripped from subprocess environments so external CLIs are not silently
misrouted or handed Hermes secrets.

See: https://github.com/NousResearch/sinria-agent/issues/1002
See: https://github.com/NousResearch/sinria-agent/issues/1264
"""
