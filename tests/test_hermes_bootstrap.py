...
(hermes, sinria-agent, hermes-acp, gateway, batch_runner, cli.py).  It
...
class TestEntryPointsImportBootstrap:
    ...
    ENTRY_POINTS = [
        ...
        "run_agent.py",          # sinria-agent (console_script)
    ...
    def test_entry_point_imports_bootstrap(self, path):
        ...
        """
        # Resolve relative to the sinria-agent repo root.  Tests live
