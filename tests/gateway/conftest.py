...
def _ensure_discord_mock() -> None:
    ...
    discord_mod.app_commands = SimpleNamespace(
        ...
        # ``autocomplete`` is used by the flat /skill command registration in
        # gateway/platforms/discord.py; test files that relied on their own
        # stub used to add it themselves — keep it here so the single shared
        # mock is complete.
