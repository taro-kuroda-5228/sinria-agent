...
class TestAuxiliaryClientProviderPriority:
    ...
    def test_openrouter_always_wins(self, monkeypatch):
        ...
        # OpenRouter uses _OPENROUTER_MODEL ("google/gemini-2.5-flash"), which
        # is deliberately distinct from _NOUS_MODEL ("google/gemini-3-flash-
        # preview") — see auxiliary_client.py near the comment at the model
        # override drop site. The Nous default is asserted separately in
        # test_nous_when_no_openrouter.
