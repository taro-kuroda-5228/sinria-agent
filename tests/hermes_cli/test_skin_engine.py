...
class TestSkinConfig:
    ...
    def test_default_skin_branding_aliases_for_sinria(self, monkeypatch):
        from hermes_cli.skin_engine import load_skin
        ...
        assert skin.get_branding("response_label") == " ⚕ Sinria "
...
class TestUserSkins:
    ...
    def test_load_user_skin_keeps_custom_branding_under_sinria(self, tmp_path, monkeypatch):
        from hermes_cli.skin_engine import load_skin
        ...
        assert skin.get_branding("agent_name") == "Custom Agent"
        assert skin.get_branding("welcome") == "Welcome to Custom Agent!"
        assert skin.get_branding("response_label") == " ✦ Custom "
