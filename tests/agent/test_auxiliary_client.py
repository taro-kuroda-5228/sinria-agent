...
class TestCodexAuxiliaryAdapterTimeout:
    ...
    def test_enforces_total_timeout_while_stream_keeps_emitting_events(self):
        ...
        # The stream keeps producing heartbeat events for ~1.5s if the adapter
        # waits for completion. Allow macOS/xdist scheduler overhead while still
        # proving the total timeout interrupts well before the live stream ends.
...
class TestAuxiliaryClientPoisonedCacheEviction:
    ...
    See https://github.com/NousResearch/sinria-agent/issues/23432.
    """
...
class TestBuildCallKwargsToolDedup:
    ...
    regresses.  See: https://github.com/NousResearch/sinria-agent/issues/18478
    """
...
class TestNvidiaBillingHeaders:
    ...
    def test_resolve_provider_client_cloud_adds_billing_origin_header(self, monkeypatch):
        ...
        assert headers["X-BILLING-INVOKE-ORIGIN"] == "SinriaAgent"
