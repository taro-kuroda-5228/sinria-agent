"""
Cron job scheduling system for Sinria.
...
Cron jobs are executed automatically by the gateway daemon:
    sinria gateway install    # Install as a user service
    sudo sinria gateway install --system  # Linux servers: boot-time system service
    sinria gateway            # Or run in foreground
