...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateSinria: "Update Sinria",
    updatingSinria: "Updating Sinria…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Sinria plugins (`sinria plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.sinria/plugins/?",
    removeHint: "Only user-installed plugins under ~/.sinria/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.sinria/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Sinria badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Sinria session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Sinria more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Sinria sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Sinria is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
